...
public class JdbcFriendsRepository implements FriendsRepository {
    ...
    @Override
    public List<Integer> mutualFriends(int userId, int friendId) {

        final String sqlQuery2 = "SELECT FR.FRIEND_ID " +
        ...
        map.addValue("userId", userId);
        map.addValue("friendId", friendId);
        return jdbcOperations.query(sqlQuery2, map, new FriendIdRowMapper());
    }
}
