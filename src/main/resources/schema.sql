ALTER TABLE FRIENDS
    DROP CONSTRAINT FK_FRIENDS_F;
ALTER TABLE FRIENDS
    DROP CONSTRAINT FK_FRIENDS_S;
ALTER TABLE LIKES
    DROP CONSTRAINT FK_LIKES_U;
ALTER TABLE LIKES
    DROP CONSTRAINT FK_LIKES_F;
ALTER TABLE FILM_GENRES
    DROP CONSTRAINT FK_FILM_GENRES_F;
ALTER TABLE FILM_GENRES
    DROP CONSTRAINT FK_FILM_GENRES_G;
ALTER TABLE MPA_FILMS
    DROP CONSTRAINT FK_MPA_FILMS_F;
ALTER TABLE MPA_FILMS
    DROP CONSTRAINT FK_MPA_FILMS_M;
